...
# this function was modified to always return a gList, whether bg.colour is NA or not.
# in addition, each background textgrob is made to have a unique name, otherwise
